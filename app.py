...
st.markdown("""
<div class="hero-card">
    <div class="brand-title">Ollama ChatGPT Clone</div>
    <div class="brand-subtitle">Building a Generative AI app using Python, Streamlit and Ollama.</div>
...
# Chat Input
# -----------------------------
user_prompt = st.chat_input("Ask anything... Try in your language too! ")
